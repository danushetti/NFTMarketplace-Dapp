...
contract NFTMarketplace is ERC721URIStorage {
    ...
    //listing the NFT on the marketplace by transfering the ownership to the contract
    ...
    // Mints a token and list it on the marketplace
    //create a New NFT and list it on the marketplace
    ...
    // selling the listed NFTmarketplace item to the buyer
